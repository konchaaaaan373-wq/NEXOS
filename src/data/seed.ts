...
export const alerts: Alert[] = [
  {
    ...
    severity: "critical",
    title: "応募への返事がまだです",
    message: "山田 花子さんの応募が48時間以上返事がありません。2日以内に返事する目標を過ぎています。",
  ...
  },
  {
    ...
    severity: "warning",
    title: "面接が進んでいません",
    message: "中村 さくらさんが面接の段階で22日間止まっています。面接日程が決まっていない可能性があります。",
  ...
  },
  {
    ...
    severity: "warning",
    title: "面接の日程が決まっていません",
    message: "中村 さくらさんの面接が設定されていません。面接の段階に進んでから22日経過しています。",
    relatedEntityId: "app-5",
    relatedEntityType: "application",
    isResolved: false,
    createdAt: "2026-04-01T09:00:00Z",
  ...
  },
  {
    ...
    type: "sla_breach",
    severity: "critical",
    title: "書類選考の対応が遅れています",
    message: "佐々木 愛さんの書類選考が20日間を超えています（目標: 5日以内）。速やかな判定が必要です。",
...
export const vacancyImpacts: VacancyImpact[] = [
  ...
  },
  {
    ...
    recommendedAction: "訪問看護師の求人（job-5）で中村さくら氏が面接の段階にいます。面接日程が22日間決まっていません。すぐに日程を調整しましょう。",
  },
  {
    facilityId: "fac-3",
