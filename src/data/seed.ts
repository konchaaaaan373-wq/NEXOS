...
export const clinics: Clinic[] = [
  {
    ...
    recruitingProfile: {
      contactPerson: "佐藤 健太",
      contactRole: "事務長",
      contactEmail: "sato@medical-frontier.example.com",
      contactPhone: "03-1234-5678",
      decisionMaker: "鈴木 院長",
      decisionProcess: "事務長が書類選考 → 院長面談 → 院長決裁",
      cultureDescription: "20代〜30代のスタッフが多く、活気がある。美容にも力を入れており、最新の医療知識への関心が高い。残業は少なめで、ワークライフバランスを重視。",
      cultureTags: ["若手が多い", "美容医療に積極的", "残業少なめ", "渋谷駅近"],
      workStyle: "外来中心、完全週休2日制。美容施術の研修制度あり。",
      goodFitDescription: "コミュニケーション力が高く、患者さんに丁寧に対応できる方。新しい知識の習得に意欲的な方が長く活躍している。",
      goodFitExamples: ["前職で美容クリニック経験あり → 即戦力として活躍", "大学病院出身の若手医師 → 幅広い診療に意欲的"],
      ngConditions: ["指示待ちタイプ", "残業前提の働き方を希望する方"],
      ngReasons: ["過去に大学病院の専門医志向の方は外来中心の勤務体制に合わず早期退職"],
      commuteArea: "渋谷・恵比寿・代官山エリアから30分圏内",
      salaryRange: "医師: 1,500万〜2,200万、看護師: 450万〜600万",
      preferredAge: "20代後半〜40代前半",
      preferredExperience: "医師: 臨床3年以上、看護師: 1年以上",
      agencyNotes: "紹介会社A社とは継続取引あり。B社は過去にミスマッチが続いたため慎重に。",
      freeNotes: "美容医療の拡大を計画中。2026年下半期に新規ラインを立ち上げ予定のため、採用を前倒しで進めたい。",
      lastUpdatedAt: "2026-03-20T10:00:00Z",
      lastUpdatedBy: "user-neco-2",
    },
    pageSections: [
  ...
  },
  {
    ...
    recruitingProfile: {
      contactPerson: "木村 直子",
      contactRole: "管理者（兼・採用担当）",
      contactEmail: "kimura@sakura-home.example.com",
      contactPhone: "03-2345-6789",
      decisionMaker: "木村 直子（管理者）",
      decisionProcess: "管理者が書類確認 → 管理者面談 → 即決裁",
      cultureDescription: "患者さんとご家族に寄り添う姿勢を大切にしている。スタッフ同士の信頼関係が厚く、困った時は助け合う文化。24時間体制のため、シフトの柔軟性も重視。",
      cultureTags: ["患者第一", "チームワーク重視", "24時間体制", "地域密着"],
      workStyle: "訪問中心。直行直帰OK。オンコール手当充実。有給取得率高い。",
      goodFitDescription: "患者さんの生活に深く関わりたい方。一人で判断する場面が多いため、自立した判断力がある方が活躍。",
      goodFitExamples: ["病棟看護師から転職 → 在宅ケアに適性があり長期活躍", "訪問看護経験者 → 即戦力として現場をリード"],
      ngConditions: ["定時で必ず帰りたい方（急変対応あり）", "一人での訪問に不安が強い方"],
      ngReasons: ["過去に急性期病院からの転職者が、在宅の判断の重さに合わず退職したケースあり"],
      commuteArea: "世田谷区・目黒区・渋谷区エリア",
      salaryRange: "医師: 1,600万〜2,400万、看護師: 500万〜650万",
      preferredAge: "30代〜50代",
      preferredExperience: "医師: 5年以上、看護師: 3年以上",
      agencyNotes: "在宅医療に詳しい紹介会社が少なく、Necoの支援を特に期待。",
      freeNotes: "世田谷区南部への訪問エリア拡大を検討中。看護師の増員が急務。",
  ...
  },
  {
    ...
    recruitingProfile: {
      contactPerson: "渡辺 慎一",
      contactRole: "事務長",
      contactEmail: "watanabe@neuroscience-tokyo.example.com",
      contactPhone: "03-3456-7890",
      decisionMaker: "院長（脳神経内科専門医）",
      decisionProcess: "事務長が書類選考 → 院長面談 → 院長決裁。専門医は学術業績も重視。",
      cultureDescription: "学術的な探究心を大切にする文化。論文執筆や学会発表を奨励。患者さんへの丁寧な説明を重視し、一人ひとりに時間をかける診療スタイル。",
      cultureTags: ["学術志向", "専門性重視", "丁寧な説明", "千代田区立地"],
      workStyle: "完全予約制のため残業少。学会参加費全額補助。論文執筆支援あり。",
      goodFitDescription: "専門性を深めたい方。大学病院の教育的環境は好きだが、もう少しクリニックの機動力が欲しい方。",
      goodFitExamples: ["大学病院助教 → 専門外来に集中できる環境を評価", "総合病院の神経内科医 → 研究と臨床の両立を実現"],
      ngConditions: ["専門分野への関心が薄い方", "学会活動に消極的な方"],
      ngReasons: ["過去に一般内科志向の医師がフィットせず短期退職"],
      commuteArea: "千代田区・文京区・中央区エリアから40分圏内",
      salaryRange: "専門医: 1,800万〜2,800万、検査技師: 450万〜550万",
      preferredAge: "30代〜50代",
      preferredExperience: "専門医取得済み or 取得予定",
      agencyNotes: "脳神経内科に強い紹介会社は限られる。専門医の紹介は高難度。",
      freeNotes: "2026年中にMRI装置を更新予定。技師の経験者採用を優先したい。",
      lastUpdatedAt: "2026-03-10T10:00:00Z",
      lastUpdatedBy: "user-c3-admin",
    },
    pageSections: [
...
export const applications: Application[] = [
  {
    ...
    matchReason: {
      score: 85,
      summary: "総合病院5年の臨床経験と美容医療への関心が、渋谷院の診療体制に合致",
      strengths: ["内科臨床5年の実績", "美容医療への積極的な関心", "コミュニケーション力の高さ（面接評価）"],
      concerns: ["美容医療の実務経験はなし"],
      recommendation: "院の「若手の挑戦を応援」する文化にフィットする可能性が高い。二次面接を推奨。",
    },
    notes: [
  ...
  },
  {
    ...
    matchReason: {
      score: 72,
      summary: "大学病院3年の看護経験。美容医療は未経験だが、学習意欲が高い",
      strengths: ["大学病院での基礎力", "美容医療への学習意欲"],
      concerns: ["美容クリニック未経験", "外来経験が少ない可能性"],
      recommendation: "基礎力はあり。研修制度が充実している渋谷院であれば育成可能。",
    },
    notes: [
  ...
  },
  {
    ...
    matchReason: {
      score: 92,
      summary: "総合内科8年の経験と在宅医療への強い情熱。即戦力として期待大",
      strengths: ["臨床8年の豊富な経験", "在宅医療への明確な志望動機", "普通自動車免許保有"],
      concerns: ["訪問診療の実務経験はなし（病院勤務のみ）"],
      recommendation: "在宅医療への情熱が本物。院の「患者第一」文化に非常にフィット。早期入職を推奨。",
    },
    notes: [
  ...
  },
  {
    ...
    matchReason: {
      score: 95,
      summary: "脳神経内科専門医・大学病院助教。学術実績も豊富で院の文化に最適",
      strengths: ["脳神経内科専門医", "10年の臨床経験", "学術実績が豊富", "教育的な姿勢"],
      concerns: ["大学病院→クリニックの環境変化への適応"],
      recommendation: "院の「学術志向」文化に完全にフィット。最優先で面接設定を推奨。",
    },
    notes: [
